/* GraphCuts.h */
/* This file originzted from the following authors */
...
#ifndef __GRAPHCUTS_H__
#define __GRAPHCUTS_H__
...
public:
    ...
    GraphCuts(PixelType width,PixelType height,int num_labels,EnergyFunction *eng);
    ...
    /* functions */
    GraphCuts(PixelType num_pixels,int nLabels, EnergyFunction *eng);
...
protected:
    ...
    void setSmoothness(EnergyTermType* /*V*/){printf("Not implemented"); exit(1);}
...
class Expansion: public GraphCuts
{
public:
    Expansion(PixelType width,PixelType height,int num_labels,EnergyFunction *eng):GraphCuts(width,height,num_labels,eng){};
